...
const iconMap = { Heart, Shield, Users, CheckCircle }
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            ...
            <div className="absolute -bottom-6 -right-6 bg-white rounded-2xl shadow-xl p-5 border border-emerald-50">
              ...
              <div className="text-slate-500 text-sm">{settings.about_stat_years_label}</div>
            </div>
            <div className="absolute -top-6 -left-6 bg-emerald-600 rounded-2xl shadow-xl p-5 text-white">
              <div className="text-3xl font-bold font-display">{settings.about_patients_value}</div>
              <div className="text-emerald-200 text-sm">{settings.about_patients_label}</div>
            </div>
          </div>
          ...
          <div className="order-1 lg:order-2">
            ...
            <h2 className="font-display font-bold text-3xl sm:text-4xl text-slate-800 mb-6 leading-tight">
              {settings.about_title}<br />
              <span className="text-emerald-600">{settings.about_subtitle}</span>
            </h2>
            <p className="text-slate-600 leading-relaxed mb-6">{settings.about_description_1}</p>
            <p className="text-slate-600 leading-relaxed mb-10">{settings.about_description_2}</p>
