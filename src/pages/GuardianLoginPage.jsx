    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-900 via-emerald-800 to-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-800 font-display">Family Portal</h1>
          <p className="text-slate-500 text-sm mt-1">
            {showForgotPassword ? 'Reset your password' : 'Green Valley Foundation — sign in to view your family member\'s progress'}
          </p>
        </div>
        ...
        {showForgotPassword ? (
          ...
          <>
            ...
            <p className="text-center text-xs text-slate-400 mt-6">
              New here? Ask the care team to send you an invite link.
            </p>
          </>
        )}
      </div>
